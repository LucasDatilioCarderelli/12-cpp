...
/*   Updated: 2023/09/24 14:04:59 by ldatilio         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm(const std::string name, const int gradeToSignin, const int gradeToExecute) :
...
int AForm::getGradeToExeceute(void) const {
	return (this->_gradeToExecute);
}

int AForm::getGradeToSignIn(void) const {
